...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(birthdayChapter){
    birthdayChapter.querySelector('.body').innerHTML=`
      ...
      <div class="p">זה מאכזב. אבל הרגש שלהם שייך להם, לא לנו.</div>
      <div class="stop">ובסופו של דבר, היכולת שלנו לקבל את הרגש הלא נעים שלהם ולהישאר לצידם בתוכו, למרות האכזבה שלנו, גם היא חלק משמעותי מן ההשקעה בהם.</div>`;
