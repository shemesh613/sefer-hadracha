...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch3){
    ...
    ch3.querySelector('.body').innerHTML=`
      ...
      <div class="p">ולאט לאט קורה דבר נוסף: הילד לומד שכל עוד אני מדבר בשקט, עדיין איני מתכוון באמת. הוא מתרגל להמתין לצעקה או לאיום, ורק אז לפעול. כך הבקשות הרגועות שלי מאבדות מכוחן, ואני נאלץ להרים את הקול שוב ושוב כדי להשיג את אותה הקשבה.</div>
      <div class="q">השגתי ציות, אבל הדרך שבה השגתי אותו החלישה את המילה שלי.</div>
      <div class="p">לעומת זאת, גם אם הילד לא הקשיב לי בכלל, ואני בכל זאת נשארתי רגוע, החזקתי בגבול אך לא איבדתי את העשתונות - לא איבדתי את הסמכות שלי. להפך.</div>
      <div class="p">את מה שדורש טיפול, שיחה או תגובה חינוכית, אפשר לעשות לאחר שהאירוע יירגע. אין צורך להשיג ציות מיידי באמצעות צעקות כדי להוכיח שאני ההורה.</div>
      <div class="p">גם אם עולה בי כעס, זה טבעי. הסמכות שלי נבחנת ביכולת לפגוש אותו, להכיל אותו ולא לתת לו לנהל את התגובה שלי או להישפך על הילד.</div>
      <div class="stop">להישאר רגוע, להחזיק בגבול ולא להוציא את הכעס על הילד - זו בעיניי סמכות אמיתית.</div>
      <div class="p">וגם הילד מרגיש אותה. הוא מרגיש שאני לא נבהל מאי-ההקשבה שלו, לא מאבד את מקומי ולא זקוק לצעקות כדי להוביל. גם אם באותו רגע הוא עדיין אינו מקשיב, לאורך זמן דווקא היציבות הזאת מחזקת את הסמכות שלי בעיניו.</div>`;
