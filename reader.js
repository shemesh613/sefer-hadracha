...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch32){
    ...
    ch32.querySelector('.body').innerHTML=`
      ...
      <div class="p">בהתחלה הם לא תמיד מבינים מה אני רוצה מהם. הם רגילים שלכל שאלה יש תשובה מן המבוגר. הם שואלים, והמבוגר אמור לומר להם בדיוק מה לעשות, כך שהם אינם נדרשים לעצור ולחשוב בעצמם. אבל אני רוצה לומר להם משהו אחר: אתה כבר יודע לחשוב. תסתכל על המצב, תבין מה נדרש ותחליט.</div>
