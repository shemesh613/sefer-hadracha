...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch2){
    ...
    ch2.querySelector('.body').innerHTML=`
      ...
      <div class="p">אבל הביטחון שלי אינו אמור להגיע מן הילד. הוא נבנה בתוכי, מתוך העבודה הפנימית שלי ומתוך הידיעה הפשוטה שאני ההורה ושאני המוביל.</div>
      ...
      <div class="q">אני ההורה. אני המוביל. הילד יכול להתווכח, להתנגד ואפילו לא להקשיב כרגע, ואני עדיין נשאר במקומי.</div>
      ...
      <div class="p">גם כשהילד אינו מקשיב לי, הקרקע מתחת לרגליי נשארת יציבה. היא אינה רועדת.</div>
      <div class="stop">וכשהקרקע מתחת לרגליי יציבה, גם לילד קל יותר להרגיש בטוח.</div>`;
