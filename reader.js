...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(birthdayChapter){
    birthdayChapter.querySelector('.body').innerHTML=`
      ...
      <div class="p">אנחנו יכולים לתכנן עבור הילד יום הולדת, להשקיע בטיול משפחתי או להכין ארוחה חגיגית. אנחנו עושים את כל זה באהבה ומתוך רצון שיהיה לו טוב, ובכל זאת הילד עשוי להתאכזב, להתעצבן או פשוט לא להיות במצב רוח ליהנות.</div>
      <div class="p">זה יכול לאכזב גם אותנו.</div>
      <div class="p">אבל רגשותיהם של הילדים אינם ברשותנו, והשקעה גדולה ככל שתהיה אינה יכולה לחייב אותם להרגיש אחרת.</div>
      <div class="stop">ולפעמים נצטרך לקבל שגם אחרי כל מה שעשינו, הילד מרגיש אחרת מכפי שקיווינו.</div>`;
