...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch3){
    ...
    ch3.querySelector('.body').innerHTML=`
      ...
      <div class="p">גם הילד מרגיש כשאני עומד מולו רגוע ובטוח. הוא מבין שאי-ההקשבה שלו אינה מערערת אותי ושאיני זקוק לצעקות כדי להוביל אותו. גם אם באותו רגע הוא עדיין אינו מקשיב, לאורך זמן היציבות הזאת מחזקת את הסמכות שלי בעיניו.</div>`;
