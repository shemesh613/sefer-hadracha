...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(birthdayChapter){
    birthdayChapter.querySelector('.body').innerHTML=`
      ...
      <div class="p">זה יכול לאכזב גם אותנו. השקענו כל כך, ובאותו רגע נדמה שכל המאמץ שלנו ירד לטמיון.</div>
      <div class="stop">ובסופו של דבר, היכולת שלנו לקבל את הרגש הלא נעים שלהם ולהישאר לצידם בתוכו, גם היא חלק משמעותי מן ההשקעה בהם.</div>`;
