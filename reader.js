...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(birthdayChapter){
    birthdayChapter.querySelector('.body').innerHTML=`
      ...
      <div class="stop">גם כשהתגובה שלו מאכזבת אותנו, וגם כשכל כך רצינו שיהיה שמח ומרוצה, עלינו לזכור שעולמו הפנימי של הילד נשאר שלו, והוא אינו חייב להרגיש אחרת כדי להתאים לציפיות שלנו.</div>`;
