...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(birthdayChapter){
    birthdayChapter.querySelector('.body').innerHTML=`
      ...
      <div class="stop">אין לי, כהורה, בעלות על מה שהילדה שלי מרגישה.</div>
      <div class="p">זה שהתאמצתי והשקעתי אינו מחייב אותה להרגיש דווקא שמחה. מותר לה להיות גם מתוסכלת, מאוכזבת או עייפה.</div>
      <div class="p">נכון, יש כאן גם ערך של הכרת הטוב. אני רוצה שהיא תראה כמה טרחו והשקיעו למענה, ולא תקבל זאת כמובן מאליו.</div>
      ...
      <div class="p">רק לאחר מכן יכולתי להתפנות באמת ולנסות להיכנס לנעליה.</div>
      <div class="q">״כל כך חיכית ליום ההולדת הזה ודמיינת איך הוא יהיה. ועכשיו לא הכול מסתדר כמו שרצית. אוף, זה מאכזב...״</div>
      <div class="p">לא ניסיתי לפרש את רגשותיה מבחוץ. ניסיתי לרגע להיכנס איתה אל תוך האכזבה ולדבר מתוכה.</div>
      <div class="p">לא ניסיתי לשכנע אותה שהיה יום הולדת נפלא, ולא מניתי בפניה את כל מה שכן הצליח. גם לא דרשתי ממנה לשמוח רק מפני שאני השקעתי.</div>
      <div class="stop">ההשקעה שלנו בילדים אינה חוזה שמחייב אותם להרגיש את הרגש שקיווינו שירגישו.</div>
      <div class="p">אנחנו יכולים לתכנן עבורם יום הולדת, להשקיע בטיול משפחתי, להכין ארוחה חגיגית או לבחור עבורם מתנה שחשבנו שתשמח אותם. אנחנו עושים את כל זה באהבה ומתוך רצון שיהיה להם טוב. ובכל זאת, הם עשויים להתאכזב.</div>
      <div class="p">בסופו של דבר, אגב, היא נהנתה מאוד.</div>
      <div class="p">אבל זה לא בהכרח תמיד מסתיים כך.</div>
      <div class="p">לפעמים נשקיע, נטרח ונעשה הכול כדי לשמח את הילד - ובכל זאת הוא יישאר מאוכזב, מתוסכל או לא מרוצה.</div>
      <div class="p">ייתכן שאפילו נרגיש שכל ההשקעה שלנו ירדה לטמיון.</div>
      <div class="p">וגם זה קורה.</div>
      <div class="p">ההשקעה היא שלנו, אבל הרגש הוא שלו.</div>
      <div class="p">אין לנו בעלות על האופן שבו הילד יחווה את מה שעשינו למענו.</div>`;
