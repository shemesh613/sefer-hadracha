...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(chapter20){
    chapter20.querySelector('.body').innerHTML=`
      ...
      <div class="p">אני רואה אותו מתאמץ, וכבר ברור לי איך אפשר לסיים את הדבר מהר יותר. זה לוקח זמן, הדרך שלו לפעמים מסורבלת, ואני כמעט בלי לשים לב אומר:</div>
      <div class="q">״בוא, אני אעזור לך.״</div>
      <div class="p">אני באמת מתכוון לעזור. אבל בתוך רגע הידיים שלי כבר עושות במקומו את מה שהוא ניסה לעשות בעצמו.</div>
      <div class="p">המשימה הושלמה מהר יותר, אבל הילד איבד הזדמנות להתנסות ולגלות שהוא מסוגל.</div>
      <div class="p">כשילד מהסס מול דבר חדש, אנחנו רוצים לעודד אותו לנסות. לפעמים יוצאות לנו מילים כמו:</div>
      <div class="q">״נו, למה אתה לא מנסה?״<br>״ממה אתה מפחד?״<br>״למה אתה מוותר כל כך מהר?״</div>
      <div class="p">אבל גם אם הכוונה שלנו טובה, האומץ לנסות אינו נבנה רק מדחיפה ומעידוד. הוא נבנה מן החוויות שבהן הילד התמודד בכוחות עצמו וגילה שהוא מסוגל.</div>
