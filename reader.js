...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch2){
    ...
    ch2.querySelector('.body').innerHTML=`
      ...
      <div class="p">אבל הביטחון שלי אינו אמור להגיע מן הילד. את הביטחון הזה עליי לבנות בתוכי, מתוך העבודה הפנימית שלי ומתוך הידיעה שאני ההורה והמוביל.</div>
      ...
      <div class="stop">וכשהקרקע מתחת לרגליי יציבה, גם לילד קל יותר להרגיש בטוח. הוא מרגיש שגם מול ההתנגדות שלו, עומד מולו הורה יציב שיכול להמשיך להוביל אותו.</div>`;
