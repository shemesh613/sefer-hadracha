...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(chapter20){
    chapter20.querySelector('.body').innerHTML=`
      <div class="p">לפעמים אני רואה את הילד שלי מתאמץ לעשות משהו, וכבר ברור לי איך אפשר לסיים את המשימה מהר יותר.</div>
      ...
      <div class="p">כשהדרך הראשונה אינה מצליחה, הוא מחפש דרך אחרת. הוא טועה, מתקן ומנסה שוב.</div>
      ...
      <div class="p">וכשהוא יצליח לבסוף, הוא יוכל להביט במה שעשה ולדעת:</div>
      <div class="q">״אני עשיתי את זה.״</div>
      <div class="p">זו אולי רק גרב שהצליח לגרוב בעצמו, משהו שהכין לאכול או משחק שהרכיב. אבל עבור הילד זו עוד חוויה שבה גילה שהוא יכול.</div>
      <div class="stop">החוויות הקטנות האלה מצטברות, ומהן נבנה לאט לאט הביטחון שלו בעצמו.</div>`;
    ...
    chapter21.innerHTML=`
      ...
      <div class="body">
        ...
        <div class="q">״אוי, מבאס שהכוס נפלה. זה קורה. חכי רגע שאאסוף, ואז תביאי את הכוס הבאה.״</div>
        ...
        <div class="p">את הבהלה ואת הצער נפגוש יחד איתו, וכשהמקום שוב בטוח, ניתן לו לחזור ולנסות.</div>
        <div class="stop">כך מצטברות בילד חוויות שבהן משהו השתבש, והוא התאושש, למד וניסה שוב. כל חוויה כזאת מוסיפה לקופה הפנימית שלו עוד מעט ביטחון בעצמו.</div>
  ...
  const newAttempt=chapter24Nodes.find(n=>n.textContent.startsWith('כשמבקשים ממנו לנסות משהו חדש'));
  if(newAttempt){
    newAttempt.textContent='במצב כזה, ניסיון חדש אינו נחווה אצלו כעוד הזדמנות קטנה. מבחינתו זהו הימור על מעט האסימונים שעוד נשארו לו. אם ייכשל, הוא חושש שלא יישאר לו דבר. לכן הוא עלול להימנע, לסרב, להגיב בכעס, לזלזל במשימה או להכריז מראש שלא אכפת לו. לפעמים מה שנראה לנו כעצלנות או כחוסר רצון הוא ילד שמגן בכל כוחו על הקופה הכמעט ריקה שלו.';
    if(!chapter24Nodes.some(n=>n.textContent.startsWith('ולא תמיד התגובה תהיה הימנעות')))
      newAttempt.insertAdjacentHTML('afterend','<div class="p">ולא תמיד התגובה תהיה הימנעות. לפעמים הילד יחפש מקום אחר שבו יוכל להרגיש שייך, חזק או מצליח, בלי לסכן את מעט האסימונים שנותרו לו. זו יכולה להיות, למשל, חבורה שמקבלת אותו בקלות ונותנת לו תחושת מעמד, גם אם כדי להשתייך אליה הוא נדרש להתנהג בדרך שאינה מיטיבה איתו.</div>');
  }
  const realChips=chapter24Nodes.find(n=>n.textContent.startsWith('ילד כזה אינו זקוק לעוד נאום'));
  if(realChips) realChips.textContent='לא יעזור אם אנאם לו עכשיו על חשיבות המאמץ או אומר לו סתם: ״אתה יכול״. הוא צריך לצבור אסימונים אמיתיים: לקבל משימה שנמצאת מעט מעל המקום שבו הוא עומד, אבל עדיין אפשרית עבורו; לפגוש מבוגר שרואה את ההתקדמות שלו; ולגלות מתוך הניסיון שלו שהמאמץ יכול להוביל להצלחה.';
  const buildThePile=chapter24Nodes.find(n=>n.textContent.startsWith('אין צורך להנמיך עבורו את החיים'));
  if(buildThePile && !chapter24Nodes.some(n=>n.textContent.includes('שחררו את כל הברגים בבית'))){
    buildThePile.insertAdjacentHTML('afterend', `
      <div class="p">ריצ׳רד לבוי אומר בחיוך: אם הילד טוב בהידוק ברגים, לפני שהוא חוזר הביתה שחררו את כל הברגים בבית ותנו לו מברג.</div>
      <div class="p">זו אמנם הגזמה, אבל הרעיון ברור: עלינו לחפש במה הילד טוב וליצור עבורו הזדמנויות אמיתיות להצליח דווקא שם.</div>`);
  }
  ...
  if(oldChapter2){
    ...
    newChapter.innerHTML=`
      ...
      <div class="body">
        ...
        <div class="p">כשאני מבין זאת, אני יכול לעצור ולחזור אל הילד.</div>
        <div class="stop">ברגע הזה הארטיק שנפל הוא כל עולמו, והאכזבה שלו אמיתית. אך זו לא תהיה האכזבה האחרונה שיפגוש.</div>
        <div class="p">במהלך חייו יהיו עוד דברים שירצה, יחכה להם ויאהב, ובכל זאת יאבדו, יישברו או לא יסתדרו כפי שקיווה. לא תמיד נוכל לתקן, ולא תמיד נהיה לידו.</div>
        <div class="p">הרגע הזה אינו רק תקלה שצריך למהר לפתור. הוא הזדמנות להיות איתו ולעזור לו לגלות שאפשר לפגוש אכזבה, לשאת אותה ולעבור דרכה.</div>
        <div class="p">ולכן, יותר משהוא זקוק כעת לפתרון, הוא זקוק לכך שאראה את הכאב שלו ואהיה איתו בתוכו.</div>
        ...
        <div class="p">הדבר הזה פוגש אותנו כשהילד נכשל במבחן, כשחבר אינו רוצה לשחק איתו, כשלא הזמינו אותו או כשמשהו שחיכה לו זמן רב אינו מתרחש כפי שקיווה.</div>
        <div class="p">אכזבה, עלבון, בושה, קנאה, פחד ובדידות הם חלק מן החיים. איננו יכולים למנוע מן הילד את הרגשות האלה, וגם לא נכון לנסות להעלים אותם בכל פעם שהם מופיעים.</div>
  ...
  if(illuminatedChapter){
    illuminatedChapter.querySelector('.body').innerHTML=`
      ...
      <div class="p">אבל באותו יום הילדים גם הסתדרו ביניהם, עזרו בבית ועשו לא מעט דברים טובים בלי שביקשנו.</div>
