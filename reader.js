...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(ch32){
    ...
    ch32.querySelector('.body').innerHTML=`
      <div class="p">אנחנו רגילים לתת לילדים הוראה כמעט על כל דבר. איפה להניח, איך לעשות, כמה לקחת ומה לעשות עכשיו.</div>
      <div class="p">גם בכיתה השאלות מתחילות כבר בתחילת השנה:</div>
      <div class="q">״הרב, איפה לשמור את הדף שחילקת?״<br>״להעתיק מן הלוח בשתי שורות או בשלוש?״</div>
      <div class="p">שתיים מן המילים הראשונות שאני מלמד את תלמידיי הן:</div>
      <div class="q">״שיקול דעת.״</div>
      <div class="p">בהתחלה הם לא תמיד מבינים מה אני רוצה מהם. הם רגילים שלכל שאלה יש תשובה מן המבוגר. אבל אני רוצה לומר להם משהו אחר: אתה כבר יודע לחשוב. תסתכל על המצב, תבין מה נדרש ותחליט.</div>
      <div class="p">במשך השנה המילים האלה נעשות חלק מן השפה של הכיתה. לא לכל פעולה הם מקבלים ממני הוראה, ולא כל בעיה חוזרת מיד אליי. אם תלמיד שכח מחברת, למשל, אני יכול לומר לו:</div>
      ...
      <div class="p">הילד נשאר עם עטיפה ביד כשאין פח בסביבה ושואל:</div>
      <div class="q">״איפה לזרוק אותה?״</div>
      <div class="p">במקום לתת מיד פתרון, אפשר לענות:</div>
      <div class="q">״שיקול דעת. מה נראה לך שאפשר לעשות?״</div>
      <div class="p">הוא יודע שלא זורקים ברחוב. עכשיו הוא צריך לחשוב בעצמו: להחזיק את העטיפה עד שנמצא פח, להכניס אותה לכיס או למצוא פתרון מתאים אחר.</div>
      ...
      <div class="p">כך גם כשמתעוררת בעיה. במקום למהר לייעץ ולספק את הפתרון, אפשר לשאול:</div>
      <div class="q">״מה נראה לך שאפשר לעשות?״</div>
      <div class="p">אולי הילד יצטרך הכוונה או עזרה, אבל המחשבה מתחילה אצלו והאחריות נשארת בידיו.</div>
