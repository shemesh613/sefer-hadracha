  ...
  if(oldChapter2){
    ...
    newChapter.innerHTML=`
      ...
      <div class="body">
        ...
        <div class="stop">ברגע הזה הארטיק שנפל הוא כל עולמו של הילד, והאכזבה שלו אמיתית. אך זו לא תהיה האכזבה האחרונה שיפגוש.</div>
        ...
        <div class="p">לכן הרגע הזה אינו רק תקלה שצריך למהר לפתור. הוא הזדמנות להיות איתו ולעזור לו לגלות שאפשר לפגוש אכזבה, לשאת אותה ולעבור דרכה.</div>
        <div class="p">יותר משהוא זקוק כעת לפתרון, הוא זקוק לכך שאראה את הכאב שלו ואהיה איתו בתוכו.</div>
